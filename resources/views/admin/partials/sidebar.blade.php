<aside class="w-60 bg-[#1d2327] text-[#c3c4c7] min-h-screen flex-shrink-0">
    ...
    <nav class="mt-2">
        ...
        <!-- Tags -->
        @can('post-list') {{-- Or specific tag permission --}}
            <a href="{{ route('admin.tags.index') }}"
                class="flex items-center px-4 py-2.5 text-sm hover:bg-[#2c3338] hover:text-[#72aee6] transition-colors {{ request()->routeIs('admin.tags.*') ? 'bg-[#2271b1] text-white' : '' }}">
                <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                </svg>
        ...
        @can('post-list')
            <a href="{{ route('admin.media.index') }}"
                class="flex items-center px-4 py-2.5 text-sm hover:bg-[#2c3338] hover:text-[#72aee6] transition-colors {{ request()->routeIs('admin.media.*') ? 'bg-[#2271b1] text-white' : '' }}">
                <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        @role('admin')
            <a href="{{ route('admin.activity-logs.index') }}"
                class="flex items-center px-4 py-2.5 text-sm hover:bg-[#2c3338] hover:text-[#72aee6] transition-colors {{ request()->routeIs('admin.activity-logs.*') ? 'bg-[#2271b1] text-white' : '' }}">
                <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        <a href="{{ route('admin.roles.index') }}"
            class="flex items-center px-4 py-2.5 text-sm hover:bg-[#2c3338] hover:text-[#72aee6] transition-colors {{ request()->routeIs('admin.roles.*') ? 'bg-[#2271b1] text-white' : '' }}">
            <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
