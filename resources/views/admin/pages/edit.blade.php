        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
                    ...
                    {{-- Metadata info --}}
                    <div class="text-[10px] text-gray-500 mb-4 space-y-1 bg-gray-50 p-2 rounded border border-dashed">
                        <p><i class="fas fa-calendar-plus mr-1"></i> <strong>Tạo:</strong> {{ $page->created_at->format('d/m/Y H:i') }}</p>
                        <p><i class="fas fa-calendar-check mr-1"></i> <strong>Cập nhật:</strong> {{ $page->updated_at->format('d/m/Y H:i') }}</p>
                        <p><i class="fas fa-user mr-1"></i> <strong>Bởi:</strong> {{ $page->user->name }}</p>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div id="featured_image_preview" class="mb-3 {{ empty($page->featured_image) ? 'hidden' : '' }}">
                        <img src="{{ !empty($page->featured_image) ? asset('storage/' . $page->featured_image) : '' }}" 
                             class="max-w-full h-auto rounded shadow-sm border border-gray-200">
                    </div>

                    <input type="hidden" name="featured_image" id="featured_image_path" value="{{ $page->featured_image }}">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <button type="button" onclick="removeFeaturedImage()" id="btn_remove_image"
                            class="bg-red-100 text-red-600 hover:bg-red-200 px-4 py-2 rounded text-sm font-medium transition-colors {{ empty($page->featured_image) ? 'hidden' : '' }}">
