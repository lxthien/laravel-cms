...
@section('content')
    <div class="max-w-5xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-semibold">Tạo User Mới</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Họ tên <span
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Mật khẩu <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Xác nhận mật khẩu <span
                                        class="text-red-500">*</span></label>
                ...
                <div class="md:col-span-1 space-y-6">
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Vai trò <span
                                    class="text-red-500">*</span></label>
                            <select name="role"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none"
                                required>
                        ...
                        <div class="border-t pt-4">
                            <button type="submit"
                                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow transition">
                                Tạo User
                            </button>
                        </div>
                    </div>
